...
export const metadata: Metadata = {
  title: '【2026最新】川崎の女性専用パーソナルジムおすすめ5選！料金比較',
...
const gyms = [
  ...
  },
  {
    ...
    reviewCount: 11,
    reviews: [
      { author: 'L.T', rating: 5, date: '1週間前', text: '食べて痩せるメソッドが最高。川崎のグルメも楽しみながらダイエット成功。' },
      { author: 'P.K', rating: 4, date: '2週間前', text: '糖質制限なしで続けやすい。ラゾーナでの買い物帰りに通えて便利。' },
      { author: 'D.N', rating: 4, date: '1ヶ月前', text: 'トレーナーの知識が豊富。食事指導が実践的で日常に活かせます。' },
    ],
    price: '2ヶ月16回 215,600円〜（税込）',
    trial: '無料カウンセリング',
    features: ['食べて痩せる', '糖質制限なし', '完全個室', '川崎駅近', '食事指導充実'],
    description: '「食べて痩せる」がコンセプト。糖質制限なしの独自メソッド。川崎駅からアクセス良好。ラゾーナ川崎での買い物ついでに通える。',
    access: 'JR「川崎駅」徒歩5分',
    address: '神奈川県川崎市川崎区（川崎駅徒歩5分）',
...
const faqs = [
  ...
  { question: '体験は無料？', answer: 'UNDEUX SUPERBODYは体験レッスン0円。OUTLINE・リボーンマイセルフ・ビーコンセプト・Bodykeは無料カウンセリング。' },
  ...
  { question: '食事指導が充実しているジムは？', answer: 'UNDEUX SUPERBODYは宅配食無料。Bodykeは「食べて痩せる」メソッド。ビーコンセプトは医師監修の食事指導。' },
  ...
  return (
    <>
      ...
      <main className="pt-16 bg-white">
        <section className="bg-gradient-to-br from-rose-100 via-rose-50 to-purple-50 py-12 md:py-16"><div className="max-w-4xl mx-auto px-6 lg:px-8"><p className="text-rose-500 text-xs mb-2">更新日 2026年04月13日</p><h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-text mb-4">【2026最新】川崎の女性専用パーソナルジム<br className="hidden md:block" />おすすめ{gyms.length}選！料金比較</h1></div></section>
        <section className="bg-white py-3 border-b border-rose-100"><div className="max-w-6xl mx-auto px-6 lg:px-8"><nav className="text-sm text-brand-light"><Link href="/" className="hover:text-rose-500 transition">ホーム</Link>{' > '}<span className="text-brand-muted">川崎</span></nav></div></section>
        <section className="py-12 bg-white"><div className="max-w-4xl mx-auto px-6 lg:px-8"><p className="text-brand-muted leading-relaxed mb-6">こんにちは、G-PersonalGym編集部です。</p><p className="text-brand-muted leading-relaxed mb-6">「川崎で女性専用のパーソナルジムを探している」「JR・京急のターミナル駅で通いやすいジムが知りたい」という方のために、川崎エリアでおすすめの女性向けパーソナルジム{gyms.length}選をまとめました。</p><div className="bg-rose-50 border-l-4 border-rose-400 p-6 mb-8"><h2 className="text-lg font-bold text-brand-text mb-4">こんな人におすすめ</h2><ul className="space-y-2 text-brand-muted"><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>川崎で女性専用パーソナルジムを探している</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>駅近で仕事帰りに通いたい</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>料金を比較して選びたい</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>食事指導も受けたい</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>子連れで通いたい</span></li></ul></div></div></section>
        <PriceComparisonTable gyms={gyms} areaName="川崎" />
        <section className="py-16 bg-rose-50" id="gyms"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">川崎のおすすめ女性向けパーソナルジム{gyms.length}選</h2><div className="space-y-8">{gyms.map((gym, index) => (<GymCard key={index} gym={gym} index={index} />))}</div></div></section>
        <section className="py-16 bg-white"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">目的別おすすめ</h2><div className="grid grid-cols-1 md:grid-cols-3 gap-8"><div className="border border-rose-200 rounded-xl p-6 hover:shadow-lg transition"><h3 className="text-xl font-bold text-brand-text mb-4">コスパ重視</h3><ul className="space-y-2 text-sm"><li className="text-brand-muted">・ビーコンセプト（18回 179,685円〜）</li><li className="text-brand-muted">・OUTLINE（16回 184,800円〜）</li><li className="text-brand-muted">・Bodyke（16回 215,600円〜）</li></ul></div><div className="border border-rose-200 rounded-xl p-6 hover:shadow-lg transition"><h3 className="text-xl font-bold text-brand-text mb-4">食事サポート重視</h3><ul className="space-y-2 text-sm"><li className="text-brand-muted">・UNDEUX SUPERBODY（宅配食無料）</li><li className="text-brand-muted">・Bodyke（食べて痩せるメソッド）</li><li className="text-brand-muted">・ビーコンセプト（医師監修指導）</li></ul></div><div className="border border-rose-200 rounded-xl p-6 hover:shadow-lg transition"><h3 className="text-xl font-bold text-brand-text mb-4">子連れ対応</h3><ul className="space-y-2 text-sm"><li className="text-brand-muted">・OUTLINE（ベビーサークル完備）</li><li className="text-brand-muted">・ビーコンセプト（託児所費用補助）</li></ul></div></div></div></section>
        <section className="py-16 bg-rose-50"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">川崎の料金相場【2026年4月】</h2><div className="grid grid-cols-1 md:grid-cols-2 gap-6"><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="font-bold text-brand-text mb-3">2ヶ月集中コース</h3><p className="text-3xl font-bold text-rose-500 mb-2">18万〜22万円</p><p className="text-sm text-brand-muted">ビーコンセプト179,685円〜が最安。横浜と同等の価格帯。</p></div><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="font-bold text-brand-text mb-3">入会金</h3><p className="text-3xl font-bold text-rose-500 mb-2">0〜5万円</p><p className="text-sm text-brand-muted">キャンペーンで入会金無料も。体験時に確認を。</p></div></div></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">川崎で選ぶ際の注意点</h2><div className="space-y-6"><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="text-lg font-bold text-brand-text mb-3">JR川崎駅と京急川崎駅は徒歩5分離れている</h3><p className="text-brand-muted leading-relaxed">JR川崎駅と京急川崎駅は約400m離れています。通いたいジムがどちらの駅に近いか事前に確認しましょう。多くのジムはJR川崎駅西口〜ラゾーナ方面に集中しています。</p></div><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="text-lg font-bold text-brand-text mb-3">品川・横浜の中間で通勤途中に最適</h3><p className="text-brand-muted leading-relaxed">川崎はJR東海道線・京急本線で品川と横浜の中間に位置。通勤途中に立ち寄れるため、仕事帰りにジムに通いたい方には最適の立地です。</p></div></div></div></section>
