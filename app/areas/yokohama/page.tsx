...
export const metadata: Metadata = {
  ...
  title: '【2026年6月最新】横浜の女性専用パーソナルジムおすすめ5選！料金比較',
...
const gyms = [
  {
    ...
    description: '横浜に6店舗展開する女性専用パーソナルジム。生涯無料アフターサポート付き。',
    access: 'JR「横浜駅」徒歩5分',
    address: 'JR「横浜駅」徒歩5分',
  ...
  },
  {
    ...
    description: '横浜駅より徒歩3分。糖質オフ宅配食無料の女性専用ジム。',
    access: 'JR「横浜駅」徒歩3分',
    address: 'JR「横浜駅」徒歩3分',
  ...
  },
  {
    ...
    description: '下半身痩せに特化した女性専用パーソナルジム。横浜駅近く。',
    access: 'JR「横浜駅」徒歩6分',
    address: 'JR「横浜駅」徒歩6分',
    popularPlan: { name: '人気プラン', description: '下半身痩せに特化した女性専用パーソナルジム。横浜駅近く。', price: '2ヶ月18回 179,685円〜（税込）' },
    options: ['ウェアレンタル無料', 'タオル完備', '食事指導あり'],
    userProfile: { ageRange: '20代〜40代が中心', genderRatio: '女性100%', purpose: ['ダイエット', 'ボディメイク', '姿勢改善'] },
    basicInfo: { hours: '10:00〜22:00', closed: '不定休', facilities: ['完全個室', 'シャワー', 'ロッカー'] },
  },
  {
    ...
    description: '女性トレーナーのみ在籍の老舗女性専用ジム。横浜駅から好アクセス。',
    access: 'JR「横浜駅」徒歩5分',
    address: 'JR「横浜駅」徒歩5分',
  ...
  },
  {
    ...
    description: 'AI主導20分トレーニング。横浜で月4回12,000円〜。',
    access: 'JR「横浜駅」徒歩5分',
    address: 'JR「横浜駅」徒歩5分',
...
const faqs = [
  { question: '横浜で女性専用のパーソナルジムはどこがおすすめ？', answer: 'OUTLINE 横浜店、UNDEUX SUPERBODY 横浜スタジオ、ビーコンセプト 横浜店が横浜で人気の女性向けパーソナルジムです。それぞれ特徴が異なるので、体験レッスンで比較するのがおすすめです。' },
  { question: '横浜のパーソナルジムの料金相場は？', answer: '横浜エリアの女性向けパーソナルジムの2ヶ月コース料金は約15万〜22万円。月額制なら月12,000円〜30,000円程度から通えます。' },
  ...
  { question: '横浜駅から近いジムは？', answer: 'OUTLINE 横浜店、UNDEUX SUPERBODY 横浜スタジオ、ビーコンセプト 横浜店が駅から近いジムです。' },
  ...
  return (
    <>
      ...
      <main data-reveal className="pt-16 bg-white">
        <section className="bg-gradient-to-br from-ivory via-ivory to-sand py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-text mb-4">
              【2026年6月最新】横浜の女性専用パーソナルジム<br className="hidden md:block" />おすすめ{gyms.length}選！料金比較
            </h1>
          </div>
        </section>
        <section className="bg-white py-3 border-b border-line">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <nav className="text-sm text-brand-light"><Link href="/" className="hover:text-accent transition">ホーム</Link>{' > '}<span className="text-brand-muted">横浜</span></nav>
          </div>
        </section>
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <p className="text-brand-muted leading-relaxed mb-6">こんにちは、G-PersonalGym編集部です。</p>
            <p className="text-brand-muted leading-relaxed mb-6">「横浜で女性専用のパーソナルジムを探している」という方のために、横浜エリアでおすすめの女性向けパーソナルジム{gyms.length}選をまとめました。</p>
            <div className="bg-ivory border-l-4 border-accent p-6 mb-8">
              <h2 className="text-lg font-bold text-brand-text mb-4">こんな人におすすめ</h2>
              <ul className="space-y-2 text-brand-muted">
                <li className="flex items-start"><span className="text-accent mr-2">✓</span><span>横浜で女性専用パーソナルジムを探している</span></li>
        ...
        <AreaContext slug="yokohama" />

        <WhyWomenOnly area="横浜" />

        <PriceComparisonTable gyms={gyms} areaName="横浜" />
        <section className="py-16 bg-ivory" id="gyms">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">横浜のおすすめ女性向けパーソナルジム{gyms.length}選</h2>
            <div className="space-y-8">{gyms.map((gym, index) => (<GymCard key={index} gym={gym} index={index} />))}</div>
          </div>
        </section>
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">横浜の料金相場【2026年4月】</h2>
        ...
        <section className="py-16 bg-ivory">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">横浜で選ぶ際の注意点</h2>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-brand-muted leading-relaxed mb-4">横浜エリアの女性向けパーソナルジム{gyms.length}選をご紹介しました。</p>
      ...
      <RelatedAreas currentSlug="yokohama" />
      <SiteFooter />
    </>
  )
}
