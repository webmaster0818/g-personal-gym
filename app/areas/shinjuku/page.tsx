...
export const metadata: Metadata = {
  alternates: { canonical: '/areas/shinjuku/' },
  title: '【2026年6月最新】新宿の女性専用パーソナルジムおすすめ6選！料金比較',
  description: '【2026年4月最新】新宿のおすすめ女性専用・女性向けパーソナルジム6選を徹底比較。料金・口コミ・特徴を網羅。',
...
const gyms = [
  {
    ...
    description: '業界初の生涯無料アフターサポート付き女性専用パーソナルジム。完全個室でベビーサークル完備。新宿駅から好アクセス。',
    access: 'JR「新宿駅」徒歩5分',
    address: 'JR「新宿駅」徒歩5分',
  ...
  },
  {
    ...
    description: '糖質オフ宅配食を無料提供する女性専用パーソナルジム。食事とトレーニングの総合サポート。',
    access: 'JR「新宿駅」徒歩5分',
    address: 'JR「新宿駅」徒歩5分',
  ...
  },
  {
    ...
    description: '医師とトレーナー共同開発の脚やせメソッド。太もも痩せ・ヒップアップに特化。',
    access: 'JR「新宿駅」徒歩6分',
    address: 'JR「新宿駅」徒歩6分',
    popularPlan: { name: '人気プラン', description: '医師とトレーナー共同開発の脚やせメソッド。太もも痩せ・ヒップアップに特化。', price: '2ヶ月18回 179,685円〜（税込）' },
    options: ['ウェアレンタル無料', 'タオル完備', '食事指導あり'],
    userProfile: { ageRange: '20代〜40代が中心', genderRatio: '女性100%', purpose: ['ダイエット', 'ボディメイク', '姿勢改善'] },
    basicInfo: { hours: '10:00〜22:00', closed: '不定休', facilities: ['完全個室', 'シャワー', 'ロッカー'] },
  },
  {
    ...
    description: 'トレーナー全員女性の老舗女性専用ジム。2万人以上の指導実績。',
    access: 'JR「新宿駅」徒歩5分',
    address: 'JR「新宿駅」徒歩5分',
  ...
  },
  {
    ...
    description: '西新宿の女性専門店。トレーナー全員女性でAI食事指導付き。月額制で通いやすい。',
    access: '都営大江戸線「都庁前駅」徒歩3分',
    address: '都営大江戸線「都庁前駅」徒歩3分',
...
const faqs = [
  { question: '新宿で女性専用のパーソナルジムはどこがおすすめ？', answer: 'OUTLINE 新宿店、UNDEUX SUPERBODY 新宿スタジオ、ビーコンセプト 新宿店が新宿で人気の女性向けパーソナルジムです。それぞれ特徴が異なるので、体験レッスンで比較するのがおすすめです。' },
  { question: '新宿のパーソナルジムの料金相場は？', answer: '新宿エリアの女性向けパーソナルジムの2ヶ月コース料金は約15万〜22万円。月額制なら月12,000円〜30,000円程度から通えます。' },
  ...
  { question: '新宿駅から近いジムは？', answer: 'OUTLINE 新宿店、UNDEUX SUPERBODY 新宿スタジオ、ビーコンセプト 新宿店が駅から近いジムです。' },
  ...
  return (
    <>
      ...
      <main data-reveal className="pt-16 bg-white">
        <section className="bg-gradient-to-br from-ivory via-ivory to-sand py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-text mb-4">
              【2026年6月最新】新宿の女性専用パーソナルジム<br className="hidden md:block" />おすすめ{gyms.length}選！料金比較
            </h1>
          </div>
        </section>
        <section className="bg-white py-3 border-b border-line">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <nav className="text-sm text-brand-light"><Link href="/" className="hover:text-accent transition">ホーム</Link>{' > '}<span className="text-brand-muted">新宿</span></nav>
          </div>
        </section>
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <p className="text-brand-muted leading-relaxed mb-6">こんにちは、G-PersonalGym編集部です。</p>
            <p className="text-brand-muted leading-relaxed mb-6">「新宿で女性専用のパーソナルジムを探している」という方のために、新宿エリアでおすすめの女性向けパーソナルジム{gyms.length}選をまとめました。</p>
            <div className="bg-ivory border-l-4 border-accent p-6 mb-8">
              <h2 className="text-lg font-bold text-brand-text mb-4">こんな人におすすめ</h2>
              <ul className="space-y-2 text-brand-muted">
                <li className="flex items-start"><span className="text-accent mr-2">✓</span><span>新宿で女性専用パーソナルジムを探している</span></li>
        ...
        <AreaContext slug="shinjuku" />

        <WhyWomenOnly area="新宿" />

        <PriceComparisonTable gyms={gyms} areaName="新宿" />
        <section className="py-16 bg-ivory" id="gyms">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">新宿のおすすめ女性向けパーソナルジム{gyms.length}選</h2>
            <div className="space-y-8">{gyms.map((gym, index) => (<GymCard key={index} gym={gym} index={index} />))}</div>
          </div>
        </section>
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">新宿の料金相場【2026年4月】</h2>
        ...
        <section className="py-16 bg-ivory">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">新宿で選ぶ際の注意点</h2>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <p className="text-brand-muted leading-relaxed mb-4">新宿エリアの女性向けパーソナルジム{gyms.length}選をご紹介しました。</p>
