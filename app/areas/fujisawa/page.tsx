  ...
  return (
    <>
      ...
      <main className="pt-16 bg-white">
        ...
        <section className="bg-white py-3 border-b border-rose-100"><div className="max-w-6xl mx-auto px-6 lg:px-8"><nav className="text-sm text-brand-light"><Link href="/" className="hover:text-rose-500 transition">ホーム</Link>{' > '}<span className="text-brand-muted">藤沢</span></nav></div></section>
        <section className="py-12 bg-white"><div className="max-w-4xl mx-auto px-6 lg:px-8"><p className="text-brand-muted leading-relaxed mb-6">こんにちは、G-PersonalGym編集部です。</p><p className="text-brand-muted leading-relaxed mb-6">「藤沢・湘南エリアで女性専用のパーソナルジムを探している」「ビーチシーズンに向けて体を引き締めたい」という方のために、藤沢エリアでおすすめの女性向けパーソナルジム{gyms.length}選をまとめました。</p><div className="bg-rose-50 border-l-4 border-rose-400 p-6 mb-8"><h2 className="text-lg font-bold text-brand-text mb-4">こんな人におすすめ</h2><ul className="space-y-2 text-brand-muted"><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>藤沢・湘南エリアで女性専用ジムを探している</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>夏に向けて美脚を目指したい</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>月額制で気軽に始めたい</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>料金を比較して選びたい</span></li><li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>子連れで通いたい</span></li></ul></div></div></section>
        <PriceComparisonTable gyms={gyms} areaName="藤沢" />
        <section className="py-16 bg-rose-50" id="gyms"><div className="max-w-6xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">藤沢のおすすめ女性向けパーソナルジム{gyms.length}選</h2><div className="space-y-8">{gyms.map((gym, index) => (<GymCard key={index} gym={gym} index={index} />))}</div></div></section>
        ...
        <section className="py-16 bg-rose-50"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">藤沢の料金相場【2026年4月】</h2><div className="grid grid-cols-1 md:grid-cols-2 gap-6"><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="font-bold text-brand-text mb-3">2ヶ月集中コース</h3><p className="text-3xl font-bold text-rose-500 mb-2">18万〜22万円</p><p className="text-sm text-brand-muted">ビーコンセプト179,685円〜が最安。都心部より若干リーズナブル。</p></div><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="font-bold text-brand-text mb-3">月額制</h3><p className="text-3xl font-bold text-rose-500 mb-2">2万円〜/月</p><p className="text-sm text-brand-muted">UNDEUX LIFE 月額19,800円〜。気軽に始められる価格帯。</p></div></div></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-6 lg:px-8"><h2 className="text-2xl md:text-3xl font-bold text-brand-text mb-8 text-center">藤沢で選ぶ際の注意点</h2><div className="space-y-6"><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="text-lg font-bold text-brand-text mb-3">湘南エリアで最もジムが充実した駅</h3><p className="text-brand-muted leading-relaxed">藤沢は湘南エリアの中心的な駅で、女性専用パーソナルジムの選択肢が最も多い。辻堂・茅ヶ崎・鎌倉からも東海道線やJR湘南新宿ラインで数分〜十数分でアクセス可能です。</p></div><div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="text-lg font-bold text-brand-text mb-3">夏のビーチシーズンを見据えた計画を</h3><p className="text-brand-muted leading-relaxed">湘南は夏のビーチが人気。水着を自信を持って着たいなら、2ヶ月前の4〜5月頃にはスタートしましょう。早めの無料カウンセリングがおすすめです。</p></div></div></div></section>
