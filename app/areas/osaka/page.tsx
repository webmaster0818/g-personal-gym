...
export const metadata: Metadata = {
  title: '【2026最新】大阪（梅田・心斎橋）の女性専用パーソナルジムおすすめ5選！料金比較',
        ...
        <section className="bg-gradient-to-br from-rose-100 via-rose-50 to-purple-50 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-text mb-4">
              【2026最新】大阪（梅田・心斎橋）の女性専用パーソナルジム<br className="hidden md:block" />おすすめ{gyms.length}選！料金比較
            </h1>
          </div>
        </section>
        <section className="bg-white py-3 border-b border-rose-100">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <nav className="text-sm text-brand-light"><Link href="/" className="hover:text-rose-500 transition">ホーム</Link>{' > '}<span className="text-brand-muted">大阪（梅田・心斎橋）</span></nav>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="bg-rose-50 border-l-4 border-rose-400 p-6 mb-8">
              ...
              <ul className="space-y-2 text-brand-muted">
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>大阪（梅田・心斎橋）で女性専用パーソナルジムを探している</span></li>
