          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="bg-rose-50 border-l-4 border-rose-400 p-6 mb-8">
              ...
              <ul className="space-y-2 text-brand-muted">
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>中目黒で女性専用パーソナルジムを探している</span></li>
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>おしゃれな雰囲気のジムに通いたい</span></li>
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>ピラティスも検討している</span></li>
