  ...
  return (
    <>
      ...
      <main className="pt-16 bg-white">
        ...
        <section className="bg-white py-3 border-b border-rose-100"><div className="max-w-6xl mx-auto px-6 lg:px-8"><nav className="text-sm text-brand-light"><Link href="/" className="hover:text-rose-500 transition">ホーム</Link>{' > '}<span className="text-brand-muted">立川</span></nav></div></section>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="bg-rose-50 border-l-4 border-rose-400 p-6 mb-8">
              ...
              <ul className="space-y-2 text-brand-muted">
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>立川で女性専用パーソナルジムを探している</span></li>
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>多摩エリアから通いたい</span></li>
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>料金を比較して選びたい</span></li>
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>月額制で通いたい</span></li>
                <li className="flex items-start"><span className="text-rose-400 mr-2">✓</span><span>下半身痩せしたい</span></li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border border-rose-200 rounded-xl p-6 hover:shadow-lg transition"><h3 className="text-xl font-bold text-brand-text mb-4">月額制で継続</h3><ul className="space-y-2 text-sm"><li className="text-brand-muted">・UNDEUX LIFE（月8回 59,400円〜）</li><li className="text-brand-muted">・継続割でお得に</li></ul></div>
              <div className="border border-rose-200 rounded-xl p-6 hover:shadow-lg transition"><h3 className="text-xl font-bold text-brand-text mb-4">子連れ対応</h3><ul className="space-y-2 text-sm"><li className="text-brand-muted">・OUTLINE（ベビーサークル完備）</li><li className="text-brand-muted">・ビーコンセプト（託児所費用補助）</li></ul></div>
            </div>
          </div>
        </section>
        <section className="py-16 bg-rose-50">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="font-bold text-brand-text mb-3">2ヶ月集中コース</h3><p className="text-3xl font-bold text-rose-500 mb-2">18万〜22万円</p><p className="text-sm text-brand-muted">OUTLINE 184,800円〜が最安クラス。都心部より若干リーズナブル。</p></div>
              <div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="font-bold text-brand-text mb-3">短期コース</h3><p className="text-3xl font-bold text-rose-500 mb-2">9.2万円〜</p><p className="text-sm text-brand-muted">リボーンマイセルフ 8回92,400円〜。まず試したい方に最適。</p></div>
            </div>
          </div>
        </section>
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="text-lg font-bold text-brand-text mb-3">多摩エリアのターミナル駅で交通至便</h3><p className="text-brand-muted leading-relaxed">立川はJR中央線・南武線・多摩モノレールが交差するターミナル駅。多摩エリア各地からアクセスしやすいため、近隣の国立・国分寺・日野・昭島からも通いやすいです。</p></div>
              <div className="bg-white rounded-xl p-6 border border-rose-200"><h3 className="text-lg font-bold text-brand-text mb-3">北口と南口でジムの場所が異なる</h3><p className="text-brand-muted leading-relaxed">立川駅は北口がルミネ・グランデュオなどの商業施設、南口はIKEA・ららぽーと方面。ジムがどちら側にあるか事前に確認しておきましょう。</p></div>
            </div>
          </div>
        </section>
        <section className="py-16 bg-rose-50">
