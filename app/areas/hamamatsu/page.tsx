...
export const metadata: Metadata = {
  ...
  title: '【2026年7月最新】浜松の女性向けパーソナルジムおすすめ3選！料金比較',
  description: '【2026年7月最新】浜松のおすすめ女性向けパーソナルジム3選を比較。BEYOND・パーソナルトレーニングジムNINE・STUDIOなど、料金・体験・特徴を各公式サイトで確認のうえ掲載しています。',
        ...
        <section className="bg-gradient-to-br from-ivory via-ivory to-sand py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-text mb-4">
              【2026年7月最新】浜松の女性向けパーソナルジム<br className="hidden md:block" />おすすめ{gyms.length}選！料金比較
            </h1>
          </div>
        </section>
