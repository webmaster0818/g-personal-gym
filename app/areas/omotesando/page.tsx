...
export const metadata: Metadata = {
  alternates: { canonical: '/areas/omotesando/' },
  title: '【2026年7月最新】表参道の女性専用パーソナルジムおすすめ6選！料金比較',
...
const gyms = [
  ...
  },
  {
    ...
    access: '「表参道」駅周辺',
    address: '表参道エリア（最寄り店舗は公式サイトでご確認ください）',
...
const faqs = [
  ...
  { question: '食事指導が充実しているジムは？', answer: 'UNDEUX SUPERBODYは宅配食と管理栄養士の毎食指導の2プランから選択可能。エクササイズコーチは糖質制限なしの「食べて痩せる」メソッドが好評。' },
  ...
  return (
    <>
      ...
      <main data-reveal className="pt-16 bg-white">
        <section className="bg-gradient-to-br from-ivory via-ivory to-sand py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-text mb-4">
              【2026年7月最新】表参道の女性専用パーソナルジム<br className="hidden md:block" />おすすめ{gyms.length}選！料金比較
            </h1>
          </div>
        </section>
        ...
        <AreaContext slug="omotesando" />

        <WhyWomenOnly area="表参道" />
