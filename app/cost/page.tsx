      ...
      <main data-reveal className="pt-16">
        ...
        <section className="py-3 bg-white border-b border-line">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <nav className="text-sm text-brand-light"><Link href="/" className="hover:text-accent transition">ホーム</Link>{' > '}<span className="text-brand-muted">料金相場ガイド</span></nav>
          </div>
        </section>
        ...
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="bg-gradient-to-br from-ivory to-sand border border-line rounded-xl p-6">
